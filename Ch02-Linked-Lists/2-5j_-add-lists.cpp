...
/**
 * [insert_athead - insert_athead a new node at head of the list]
...
Node * add_iterative( Node * list1, Node * list2 ) {
  ...
  //for the last digit, if it need carry
  if ( carry > 0 ) {
...
Node * add_followup( Node * list1, Node * list2 ) {
  ...
  //pad zero to the end of the smaller list
  if ( len1 > len2 ) {
...
int main()
{
  ...
  Node * list1 = nullptr;
  insert_athead(list1, 6);
  insert_athead(list1, 1);
  insert_athead(list1, 7);
  std::cout << "List1:  ";
  printList(list1);

  //making list2 for number 295
  Node * list2 = nullptr;
  insert_athead(list2, 2);
  insert_athead(list2, 9);
  insert_athead(list2, 5);
  std::cout << "List2:  ";
  printList(list2);
  ...
  //Node * listx = nullptr;
  insert_athead(list1, 4);
  insert_athead(list1, 3);
  insert_athead(list1, 2);
  insert_athead(list1, 9);
  std::cout << "List1:  ";
  printList(list1);

  insert_athead(list2, 9);
  insert_athead(list2, 9);
  insert_athead(list2, 8);
  std::cout << "List2:  ";
  printList(list2);
